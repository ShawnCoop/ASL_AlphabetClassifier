# changed implementation to generate test images and is currently not working correctly will update ASAP
...
#     for file in files:
#         if file.startswith("cropped") or file.startswith("capture"):
...
#                         pc = os.path.sep.join(['img_captures', "cropped{}.png".format(str(now).replace(":",''))])
...
# #NOT IN USE NOW FUNCTIONALITY MOVED TO PROCESS METHOD
